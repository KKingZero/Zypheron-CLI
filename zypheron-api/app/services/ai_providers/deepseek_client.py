"""DeepSeek API client with security and performance optimizations."""
...
class DeepSeekProvider(BaseAIProvider):
    """DeepSeek API client with streaming support and error handling.
    ...
    async def _complete_chat_completion(
        ...
        """DeepSeek-specific non-streaming chat completion implementation."""
    ...
    async def _stream_chat_completion(
        ...
        """DeepSeek-specific streaming chat completion implementation."""
    ...
    async def _parse_stream(
        ...
        try:
            async for line in response.aiter_lines():
                ...
                # DeepSeek SSE format: "data: {json}" (OpenAI-compatible)
                ...
                try:
                    ...
                    logger.warning("deepseek_invalid_stream_chunk", chunk=data_str[:100])
                    continue
