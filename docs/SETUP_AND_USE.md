...
| **Web Application** | nikto, nuclei, sqlmap, gobuster, ffuf | High |
...
- Linux/macOS: `~/.config/zypheron/config.yaml`
- Windows: `%APPDATA%\zypheron\config.yaml`
...
- GitHub Issues: https://github.com/KKingZero/Zypheron-CLI/issues
