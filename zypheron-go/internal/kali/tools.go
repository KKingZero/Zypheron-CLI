...
func getInstallCommand(toolName string) (string, []string, error) {
	...
	installCommands := map[string]struct {
		...
		"httpx":        {"bash", []string{"-c", "command -v go >/dev/null 2>&1 && go install -v github.com/projectdiscovery/httpx/cmd/httpx@latest || (sudo apt-get update && sudo apt-get install -y golang-go && go install -v github.com/projectdiscovery/httpx/cmd/httpx@latest)"}},
		"katana":       {"bash", []string{"-c", "command -v go >/dev/null 2>&1 && go install -v github.com/projectdiscovery/katana/cmd/katana@latest || (sudo apt-get update && sudo apt-get install -y golang-go && go install -v github.com/projectdiscovery/katana/cmd/katana@latest)"}},
		"gau":          {"bash", []string{"-c", "command -v go >/dev/null 2>&1 && go install -v github.com/lc/gau/v2/cmd/gau@latest || (sudo apt-get update && sudo apt-get install -y golang-go && go install -v github.com/lc/gau/v2/cmd/gau@latest)"}},
		"waybackurls":  {"bash", []string{"-c", "command -v go >/dev/null 2>&1 && go install -v github.com/tomnomnom/waybackurls@latest || (sudo apt-get update && sudo apt-get install -y golang-go && go install -v github.com/tomnomnom/waybackurls@latest)"}},
		"assetfinder":  {"bash", []string{"-c", "command -v go >/dev/null 2>&1 && go install -v github.com/tomnomnom/assetfinder@latest || (sudo apt-get update && sudo apt-get install -y golang-go && go install -v github.com/tomnomnom/assetfinder@latest)"}},
		...
		"dirsearch":    {"bash", []string{"-c", "command -v pip3 >/dev/null 2>&1 && python3 -m pip install --user dirsearch || (sudo apt-get install -y python3-pip && python3 -m pip install --user dirsearch)"}},
		"wfuzz":        {"bash", []string{"-c", "command -v pip3 >/dev/null 2>&1 && python3 -m pip install --user wfuzz || (sudo apt-get install -y python3-pip && python3 -m pip install --user wfuzz)"}},
		"kiterunner":   {"bash", []string{"-c", "command -v go >/dev/null 2>&1 && go install -v github.com/assetnote/kiterunner/cmd/kr@latest || (sudo apt-get update && sudo apt-get install -y golang-go && go install -v github.com/assetnote/kiterunner/cmd/kr@latest)"}},
		"kr":           {"bash", []string{"-c", "command -v go >/dev/null 2>&1 && go install -v github.com/assetnote/kiterunner/cmd/kr@latest || (sudo apt-get update && sudo apt-get install -y golang-go && go install -v github.com/assetnote/kiterunner/cmd/kr@latest)"}},
		...
		"newman":       {"bash", []string{"-c", "command -v npm >/dev/null 2>&1 && sudo npm install -g newman || (sudo apt-get install -y npm && sudo npm install -g newman)"}},
		"schemathesis": {"bash", []string{"-c", "command -v pip3 >/dev/null 2>&1 && python3 -m pip install --user schemathesis || (sudo apt-get install -y python3-pip && python3 -m pip install --user schemathesis)"}},
		"jwt-tool":     {"bash", []string{"-c", "command -v pip3 >/dev/null 2>&1 && python3 -m pip install --user jwt-tool || (sudo apt-get install -y python3-pip && python3 -m pip install --user jwt-tool)"}},
		"jwt_tool":     {"bash", []string{"-c", "command -v pip3 >/dev/null 2>&1 && python3 -m pip install --user jwt-tool || (sudo apt-get install -y python3-pip && python3 -m pip install --user jwt-tool)"}},
