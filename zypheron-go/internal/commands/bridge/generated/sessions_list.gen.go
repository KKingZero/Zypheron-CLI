...
// Source operation: listSessions (GET /v1/sessions)
...
// ListSessionsCmd Inventory of paired CLI clients on this desktop.
func ListSessionsCmd() *cobra.Command {
	cmd := &cobra.Command{
		Use:   "list",
		Short: "Inventory of paired CLI clients on this desktop.",
	}
	jsonOut := false
