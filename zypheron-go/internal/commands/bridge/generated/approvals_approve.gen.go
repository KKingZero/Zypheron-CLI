...
// Source operation: approveApproval (POST /v1/approvals/{id}/approve)
...
// ApproveApprovalCmd Approve a pending approval request.
func ApproveApprovalCmd() *cobra.Command {
	cmd := &cobra.Command{
		Use:   "approve",
