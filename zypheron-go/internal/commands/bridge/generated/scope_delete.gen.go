...
// Source operation: deleteScope (DELETE /v1/scope/{id})
...
// DeleteScopeCmd Drop one scope rule by id.
func DeleteScopeCmd() *cobra.Command {
	cmd := &cobra.Command{
		Use:   "delete",
		Short: "Drop one scope rule by id.",
	}
	var flagId string
